...
class PointAPITests(APITestCase):
    ...
    def test_search_radius(self):
        ...
        params ={
            'latitude': 39.123961,
            'longitude': 44.994306,
            'radius': 1000 # радиус поиска 1 км
        }
    ...
    def test_anonymous_access(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED) # получаем ответ и видим что нас не пускает
